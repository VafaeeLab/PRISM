...
# Remove rows with NA in the third column
BRCA_ME  <- BRCA_ME[!is.na(BRCA_ME[[3]]), ]
BRCA_GE  <- BRCA_GE[!is.na(BRCA_GE[[3]]), ]
BRCA_DM  <- BRCA_DM[!is.na(BRCA_DM[[3]]), ]
BRCA_CNV <- BRCA_CNV[!is.na(BRCA_CNV[[3]]), ]
# Preprocess-----------------------------------------------------------------------
...
BRCA_ME_normalized <- BRCA_ME_normalized[!is.na(BRCA_ME_normalized$overall_survival), ]
#robust_feature_elimination(BRCA_ME_normalized, directory = "BRCA/2S", file_prefix = "BRCA_ME_Fusion")
#-------------------------------------------------------------------------------
# GE 
BRCA_GE_normalized$overall_survival[BRCA_GE_normalized$overall_survival <= 0] <- 0.001
BRCA_GE_normalized <- BRCA_GE_normalized[!is.na(BRCA_GE_normalized$overall_survival), ]
#robust_feature_elimination(BRCA_GE_normalized, directory = "BRCA/2S", file_prefix = "BRCA_GE_Fusion")

#-------------------------------------------------------------------------------
# DM 
BRCA_DM_filtered$overall_survival[BRCA_DM_filtered$overall_survival <= 0] <- 0.001
BRCA_DM_filtered <- BRCA_DM_filtered[!is.na(BRCA_DM_filtered$overall_survival), ]
#robust_feature_elimination(BRCA_DM_filtered, directory = "BRCA/2S", file_prefix = "BRCA_DM_Fusion")

#-------------------------------------------------------------------------------
# CNV 
BRCA_CNV_normalized$overall_survival[BRCA_CNV_normalized$overall_survival <= 0] <- 0.001
BRCA_CNV_normalized <-  BRCA_CNV_normalized[!is.na(BRCA_CNV_normalized$overall_survival), ]
#robust_feature_elimination(BRCA_CNV_normalized, directory = "BRCA/2S", file_prefix = "BRCA_CNV_Fusion")


ME_fusion=read.csv("BRCA/2S/BRCA_ME_Fusion_selected_features.csv", row.names = NULL)
DM_fusion=read.csv("BRCA/2S/BRCA_DM_Fusion_selected_features.csv", row.names = NULL)
GE_fusion=read.csv("BRCA/2S/BRCA_GE_Fusion_selected_features.csv", row.names = NULL)
CNV_fusion=read.csv("BRCA/2S/BRCA_CNV_Fusion_selected_features.csv", row.names = NULL)

# Preprocess-----------------------------------------------------------------------

BRCA_ME_filtered <- BRCA_ME_filtered[, names(BRCA_ME_filtered) %in% ME_fusion$Feature, drop = FALSE]
BRCA_ME_filtered <- cbind(BRCA_ME[, 1:3], BRCA_ME_filtered)
BRCA_GE_filtered <- BRCA_GE_filtered[, names(BRCA_GE_filtered) %in% GE_fusion$Feature, drop = FALSE]
BRCA_GE_filtered <- cbind(BRCA_GE[, 1:3], BRCA_GE_filtered)
BRCA_DM_filtered <- BRCA_DM_filtered[, names(BRCA_DM_filtered) %in% DM_fusion$Feature, drop = FALSE]
BRCA_DM_filtered <- cbind(BRCA_DM[, 1:3], BRCA_DM_filtered)
BRCA_CNV_filtered <- BRCA_CNV_filtered[, names(BRCA_CNV_filtered) %in% CNV_fusion$Feature, drop = FALSE]
BRCA_CNV_filtered <- cbind(BRCA_CNV[, 1:3], BRCA_CNV_filtered)
...
robust_feature_elimination(BRCA_ME_GE, directory = "BRCA/2S", file_prefix = "BRCA_ME_GE")
...
robust_feature_elimination(BRCA_ME_DM, directory = "BRCA/2S", file_prefix = "BRCA_ME_DM")
...
robust_feature_elimination(BRCA_DM_GE, directory = "BRCA/2S", file_prefix = "BRCA_DM_GE")
...
robust_feature_elimination(BRCA_GE_CNV, directory = "BRCA/2S", file_prefix = "BRCA_GE_CNV")
...
robust_feature_elimination(BRCA_ME_CNV, directory = "BRCA/2S", file_prefix = "BRCA_ME_CNV")
...
robust_feature_elimination(BRCA_DM_CNV, directory = "BRCA/2S", file_prefix = "BRCA_DM_CNV")
...
robust_feature_elimination(BRCA_DM_GE_ME, directory = "BRCA/2S", file_prefix = "BRCA_DM_GE_ME")
...
robust_feature_elimination(BRCA_DM_GE_CNV, directory = "BRCA/2S", file_prefix = "BRCA_DM_GE_CNV")
...
robust_feature_elimination(BRCA_DM_ME_CNV, directory = "BRCA/2S", file_prefix = "BRCA_DM_ME_CNV")
...
robust_feature_elimination(BRCA_ME_GE_CNV, directory = "BRCA/2S", file_prefix = "BRCA_ME_GE_CNV")
...
robust_feature_elimination(BRCA_ME_GE_CNV_DM, directory = "BRCA/2S", file_prefix = "BRCA_ME_GE_CNV_DM")
...
# Remove rows with NA in the third column
UCEC_ME  <- UCEC_ME[!is.na(UCEC_ME[[3]]), ]
UCEC_GE  <- UCEC_GE[!is.na(UCEC_GE[[3]]), ]
UCEC_DM  <- UCEC_DM[!is.na(UCEC_DM[[3]]), ]
UCEC_CNV <- UCEC_CNV[!is.na(UCEC_CNV[[3]]), ]
...
UCEC_ME_normalized <- UCEC_ME_normalized[!is.na(UCEC_ME_normalized$overall_survival), ]
robust_feature_elimination(UCEC_ME_normalized, directory = "UCEC/2S", file_prefix = "UCEC_ME_Fusion")
#-------------------------------------------------------------------------------
# GE 
UCEC_GE_normalized$overall_survival[UCEC_GE_normalized$overall_survival <= 0] <- 0.001
UCEC_GE_normalized <- UCEC_GE_normalized[!is.na(UCEC_GE_normalized$overall_survival), ]
robust_feature_elimination(UCEC_GE_normalized, directory = "UCEC/2S", file_prefix = "UCEC_GE_Fusion")

#-------------------------------------------------------------------------------
# DM 
UCEC_DM_filtered$overall_survival[UCEC_DM_filtered$overall_survival <= 0] <- 0.001
UCEC_DM_filtered <- UCEC_DM_filtered[!is.na(UCEC_DM_filtered$overall_survival), ]
robust_feature_elimination(UCEC_DM_filtered, directory = "UCEC/2S", file_prefix = "UCEC_DM_Fusion")

#-------------------------------------------------------------------------------
# CNV 
UCEC_CNV_normalized$overall_survival[UCEC_CNV_normalized$overall_survival <= 0] <- 0.001
UCEC_CNV_normalized <-  UCEC_CNV_normalized[!is.na(UCEC_CNV_normalized$overall_survival), ]
robust_feature_elimination(UCEC_CNV_normalized, directory = "UCEC/2S", file_prefix = "UCEC_CNV_Fusion")


ME_fusion=read.csv("UCEC/2S/UCEC_ME_Fusion_selected_features.csv", row.names = NULL)
DM_fusion=read.csv("UCEC/2S/UCEC_DM_Fusion_selected_features.csv", row.names = NULL)
GE_fusion=read.csv("UCEC/2S/UCEC_GE_Fusion_selected_features.csv", row.names = NULL)
CNV_fusion=read.csv("UCEC/2S/UCEC_CNV_Fusion_selected_features.csv", row.names = NULL)

# Preprocess-----------------------------------------------------------------------

UCEC_ME_filtered <- UCEC_ME_filtered[, names(UCEC_ME_filtered) %in% ME_fusion$Feature, drop = FALSE]
UCEC_ME_filtered <- cbind(UCEC_ME[, 1:3], UCEC_ME_filtered)
UCEC_GE_filtered <- UCEC_GE_filtered[, names(UCEC_GE_filtered) %in% GE_fusion$Feature, drop = FALSE]
UCEC_GE_filtered <- cbind(UCEC_GE[, 1:3], UCEC_GE_filtered)
UCEC_DM_filtered <- UCEC_DM_filtered[, names(UCEC_DM_filtered) %in% DM_fusion$Feature, drop = FALSE]
UCEC_DM_filtered <- cbind(UCEC_DM[, 1:3], UCEC_DM_filtered)
UCEC_CNV_filtered <- UCEC_CNV_filtered[, names(UCEC_CNV_filtered) %in% CNV_fusion$Feature, drop = FALSE]
UCEC_CNV_filtered <- cbind(UCEC_CNV[, 1:3], UCEC_CNV_filtered)
...
robust_feature_elimination(UCEC_ME_GE, directory = "UCEC/2S", file_prefix = "UCEC_ME_GE")
...
robust_feature_elimination(UCEC_ME_DM, directory = "UCEC/2S", file_prefix = "UCEC_ME_DM")
...
robust_feature_elimination(UCEC_DM_GE, directory = "UCEC/2S", file_prefix = "UCEC_DM_GE")
...
robust_feature_elimination(UCEC_GE_CNV, directory = "UCEC/2S", file_prefix = "UCEC_GE_CNV")
...
robust_feature_elimination(UCEC_ME_CNV, directory = "UCEC/2S", file_prefix = "UCEC_ME_CNV")
...
robust_feature_elimination(UCEC_DM_CNV, directory = "UCEC/2S", file_prefix = "UCEC_DM_CNV")
...
robust_feature_elimination(UCEC_DM_GE_ME, directory = "UCEC/2S", file_prefix = "UCEC_DM_GE_ME")
...
robust_feature_elimination(UCEC_DM_GE_CNV, directory = "UCEC/2S", file_prefix = "UCEC_DM_GE_CNV")
...
robust_feature_elimination(UCEC_DM_ME_CNV, directory = "UCEC/2S", file_prefix = "UCEC_DM_ME_CNV")
...
robust_feature_elimination(UCEC_ME_GE_CNV, directory = "UCEC/2S", file_prefix = "UCEC_ME_GE_CNV")
...
robust_feature_elimination(UCEC_ME_GE_CNV_DM, directory = "UCEC/2S", file_prefix = "UCEC_ME_GE_CNV_DM")
...
# Remove rows with NA in the third column
CESC_ME  <- CESC_ME[!is.na(CESC_ME[[3]]), ]
CESC_GE  <- CESC_GE[!is.na(CESC_GE[[3]]), ]
CESC_DM  <- CESC_DM[!is.na(CESC_DM[[3]]), ]
CESC_CNV <- CESC_CNV[!is.na(CESC_CNV[[3]]), ]
...
CESC_ME_normalized <- CESC_ME_normalized[!is.na(CESC_ME_normalized$overall_survival), ]
robust_feature_elimination(CESC_ME_normalized, directory = "CESC/2S", file_prefix = "CESC_ME_Fusion")
#-------------------------------------------------------------------------------
# GE 
CESC_GE_normalized$overall_survival[CESC_GE_normalized$overall_survival <= 0] <- 0.001
CESC_GE_normalized <- CESC_GE_normalized[!is.na(CESC_GE_normalized$overall_survival), ]
robust_feature_elimination(CESC_GE_normalized, directory = "CESC/2S", file_prefix = "CESC_GE_Fusion")

#-------------------------------------------------------------------------------
# DM 
CESC_DM_filtered$overall_survival[CESC_DM_filtered$overall_survival <= 0] <- 0.001
CESC_DM_filtered <- CESC_DM_filtered[!is.na(CESC_DM_filtered$overall_survival), ]
robust_feature_elimination(CESC_DM_filtered, directory = "CESC/2S", file_prefix = "CESC_DM_Fusion")

#-------------------------------------------------------------------------------
# CNV 
CESC_CNV_normalized$overall_survival[CESC_CNV_normalized$overall_survival <= 0] <- 0.001
CESC_CNV_normalized <-  CESC_CNV_normalized[!is.na(CESC_CNV_normalized$overall_survival), ]
robust_feature_elimination(CESC_CNV_normalized, directory = "CESC/2S", file_prefix = "CESC_CNV_Fusion")


ME_fusion=read.csv("CESC/2S/CESC_ME_Fusion_selected_features.csv", row.names = NULL)
DM_fusion=read.csv("CESC/2S/CESC_DM_Fusion_selected_features.csv", row.names = NULL)
GE_fusion=read.csv("CESC/2S/CESC_GE_Fusion_selected_features.csv", row.names = NULL)
CNV_fusion=read.csv("CESC/2S/CESC_CNV_Fusion_selected_features.csv", row.names = NULL)

# Preprocess-----------------------------------------------------------------------

CESC_ME_filtered <- CESC_ME_filtered[, names(CESC_ME_filtered) %in% ME_fusion$Feature, drop = FALSE]
CESC_ME_filtered <- cbind(CESC_ME[, 1:3], CESC_ME_filtered)
CESC_GE_filtered <- CESC_GE_filtered[, names(CESC_GE_filtered) %in% GE_fusion$Feature, drop = FALSE]
CESC_GE_filtered <- cbind(CESC_GE[, 1:3], CESC_GE_filtered)
CESC_DM_filtered <- CESC_DM_filtered[, names(CESC_DM_filtered) %in% DM_fusion$Feature, drop = FALSE]
CESC_DM_filtered <- cbind(CESC_DM[, 1:3], CESC_DM_filtered)
CESC_CNV_filtered <- CESC_CNV_filtered[, names(CESC_CNV_filtered) %in% CNV_fusion$Feature, drop = FALSE]
CESC_CNV_filtered <- cbind(CESC_CNV[, 1:3], CESC_CNV_filtered)
...
robust_feature_elimination(CESC_ME_GE, directory = "CESC/2S", file_prefix = "CESC_ME_GE")
...
robust_feature_elimination(CESC_ME_DM, directory = "CESC/2S", file_prefix = "CESC_ME_DM")
...
robust_feature_elimination(CESC_DM_GE, directory = "CESC/2S", file_prefix = "CESC_DM_GE")
...
robust_feature_elimination(CESC_GE_CNV, directory = "CESC/2S", file_prefix = "CESC_GE_CNV")
...
robust_feature_elimination(CESC_ME_CNV, directory = "CESC/2S", file_prefix = "CESC_ME_CNV")
...
robust_feature_elimination(CESC_DM_CNV, directory = "CESC/2S", file_prefix = "CESC_DM_CNV")
...
robust_feature_elimination(CESC_DM_GE_ME, directory = "CESC/2S", file_prefix = "CESC_DM_GE_ME")
...
robust_feature_elimination(CESC_DM_GE_CNV, directory = "CESC/2S", file_prefix = "CESC_DM_GE_CNV")
...
robust_feature_elimination(CESC_DM_ME_CNV, directory = "CESC/2S", file_prefix = "CESC_DM_ME_CNV")
...
robust_feature_elimination(CESC_ME_GE_CNV, directory = "CESC/2S", file_prefix = "CESC_ME_GE_CNV")
...
robust_feature_elimination(CESC_ME_GE_CNV_DM, directory = "CESC/2S", file_prefix = "CESC_ME_GE_CNV_DM")
...
# Remove rows with NA in the third column
OV_ME  <- OV_ME[!is.na(OV_ME[[3]]), ]
OV_GE  <- OV_GE[!is.na(OV_GE[[3]]), ]
OV_DM  <- OV_DM[!is.na(OV_DM[[3]]), ]
OV_CNV <- OV_CNV[!is.na(OV_CNV[[3]]), ]
...
OV_ME_normalized <- OV_ME_normalized[!is.na(OV_ME_normalized$overall_survival), ]
robust_feature_elimination(OV_ME_normalized, directory = "OV/2S", file_prefix = "OV_ME_Fusion")
#-------------------------------------------------------------------------------
# GE 
OV_GE_normalized$overall_survival[OV_GE_normalized$overall_survival <= 0] <- 0.001
OV_GE_normalized <- OV_GE_normalized[!is.na(OV_GE_normalized$overall_survival), ]
robust_feature_elimination(OV_GE_normalized, directory = "OV/2S", file_prefix = "OV_GE_Fusion")

#-------------------------------------------------------------------------------
# DM 
OV_DM_filtered$overall_survival[OV_DM_filtered$overall_survival <= 0] <- 0.001
OV_DM_filtered <- OV_DM_filtered[!is.na(OV_DM_filtered$overall_survival), ]
robust_feature_elimination(OV_DM_filtered, directory = "OV/2S", file_prefix = "OV_DM_Fusion")

#-------------------------------------------------------------------------------
# CNV 
OV_CNV_normalized$overall_survival[OV_CNV_normalized$overall_survival <= 0] <- 0.001
OV_CNV_normalized <-  OV_CNV_normalized[!is.na(OV_CNV_normalized$overall_survival), ]
robust_feature_elimination(OV_CNV_normalized, directory = "OV/2S", file_prefix = "OV_CNV_Fusion")


ME_fusion=read.csv("OV/2S/OV_ME_Fusion_selected_features.csv", row.names = NULL)
DM_fusion=read.csv("OV/2S/OV_DM_Fusion_selected_features.csv", row.names = NULL)
GE_fusion=read.csv("OV/2S/OV_GE_Fusion_selected_features.csv", row.names = NULL)
CNV_fusion=read.csv("OV/2S/OV_CNV_Fusion_selected_features.csv", row.names = NULL)

# Preprocess-----------------------------------------------------------------------

OV_ME_filtered <- OV_ME_filtered[, names(OV_ME_filtered) %in% ME_fusion$Feature, drop = FALSE]
OV_ME_filtered <- cbind(OV_ME[, 1:3], OV_ME_filtered)
OV_GE_filtered <- OV_GE_filtered[, names(OV_GE_filtered) %in% GE_fusion$Feature, drop = FALSE]
OV_GE_filtered <- cbind(OV_GE[, 1:3], OV_GE_filtered)
OV_DM_filtered <- OV_DM_filtered[, names(OV_DM_filtered) %in% DM_fusion$Feature, drop = FALSE]
OV_DM_filtered <- cbind(OV_DM[, 1:3], OV_DM_filtered)
OV_CNV_filtered <- OV_CNV_filtered[, names(OV_CNV_filtered) %in% CNV_fusion$Feature, drop = FALSE]
OV_CNV_filtered <- cbind(OV_CNV[, 1:3], OV_CNV_filtered)
...
robust_feature_elimination(OV_ME_GE, directory = "OV/2S", file_prefix = "OV_ME_GE")
...
robust_feature_elimination(OV_ME_DM, directory = "OV/2S", file_prefix = "OV_ME_DM")
...
robust_feature_elimination(OV_DM_GE, directory = "OV/2S", file_prefix = "OV_DM_GE")
...
robust_feature_elimination(OV_GE_CNV, directory = "OV/2S", file_prefix = "OV_GE_CNV")
...
robust_feature_elimination(OV_ME_CNV, directory = "OV/2S", file_prefix = "OV_ME_CNV")
...
robust_feature_elimination(OV_DM_CNV, directory = "OV/2S", file_prefix = "OV_DM_CNV")
...
robust_feature_elimination(OV_DM_GE_ME, directory = "OV/2S", file_prefix = "OV_DM_GE_ME")
...
robust_feature_elimination(OV_DM_GE_CNV, directory = "OV/2S", file_prefix = "OV_DM_GE_CNV")
...
robust_feature_elimination(OV_DM_ME_CNV, directory = "OV/2S", file_prefix = "OV_DM_ME_CNV")
...
robust_feature_elimination(OV_ME_GE_CNV, directory = "OV/2S", file_prefix = "OV_ME_GE_CNV")
...
robust_feature_elimination(OV_ME_GE_CNV_DM, directory = "OV/2S", file_prefix = "OV_ME_GE_CNV_DM")
